...
void AEnemy::PawnSeen(APawn* SeenPawn)
{
	...
	if (SeenPawn->ActorHasTag(FName("SlashCourseCharacter")))
	{
...
{
	if (!InTargetRange(CombatTarget, CombatRadius)) //Outside Combat Range
	{
	...
	else if (!InTargetRange(CombatTarget, AttackingRadius) && EnemyState != EEnemyState::EES_Chasing) //Outside Attack Range
	{
		EnemyState = EEnemyState::EES_Chasing;
		GetCharacterMovement()->MaxWalkSpeed = 300.f;
		MoveToTarget(CombatTarget);
	}
	else if (InTargetRange(CombatTarget, AttackingRadius) && EnemyState != EEnemyState::EES_Attacking) //Inside Attacking Range
	{
